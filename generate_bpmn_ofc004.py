...
NODES: list[Node] = [
    # -- Trigger ----------------------------------------------------------
    N("StartEvent_AdmissionNotification", "start_message", CM,
    ...
    N("Task_DoNotAuthorizeContact", "task", CM,
      "Do not authorize contact with the restricted person", "P1",
      ttype="manual"),
    N("Gateway_ConsumerRequestsRestricted", "gateway_x", CM,
      "Consumer requests prohibited contact?", "P1"),
    N("Task_InformConsumerOfRestriction", "task", CM,
      "Inform the Consumer of the restriction", "P1",
      ttype="manual"),
    N("Gateway_ProtectiveOrderJoin", "gateway_x", CM,
      "", "P1"),

    # -- P2: Complete & Distribute Elopement Form ----------------------
    N("Task_ObtainRemainingInfo", "task", CM,
      "Obtain remaining consumer information after arrival and complete "
      "the Elopement Form", "P2", ttype="user"),
    N("Task_EmailElopementForm", "task", CM,
      "Email the completed Elopement Form to admissions staff", "P2",
      ttype="send"),

    # -- P3: Treatment Advocate Designation (Option C, D) ---------------
    N("Task_ReviewTAFormWithConsumer", "task", CM,
      "Review the Treatment Advocate Form with the Consumer", "P3",
      ttype="user"),
    N("Gateway_ConsumerAbleToParticipate", "gateway_x", CM,
      "Consumer able to participate?", "P3",
      doc=["Option C — the Consumer is too agitated, delusional, or unable "
           "to participate effectively."]),
    N("Task_PostponeActivity", "task", CM,
      "Postpone the activity", "P3", ttype="manual",
    ...
    N("Task_ReturnWhenAble", "task", CM,
      "Return when the Consumer is able to participate", "P3",
      ttype="manual"),
    N("Task_PeriodicFollowUp", "task", CM,
      "Continue periodic follow-up during the week", "P3",
      ttype="manual"),
    N("Task_ConsumerIdentifiesAdvocate", "task", CON,
      "Identify a prospective external Treatment Advocate", "P3",
      ttype="manual"),
    N("Task_ContactAdvocate", "task", CM,
    ...
    N("Task_MailCopyToAdvocate", "task", CM,
      "Mail a copy to the Treatment Advocate", "P3", ttype="send"),
    N("Gateway_AdvocateChangeRequested", "gateway_x", CM,
    ...
    N("Task_ProcessAdvocateChange", "task", CM,
      "Process the new Treatment Advocate designation", "P3",
      ttype="user",
    ...
    N("Gateway_AdvocateChangeJoin", "gateway_x", CM,
      "", "P3"),

    # -- P4: Nursing Handoff -----------------------------------------------
    N("Task_NursingCompletesAdmission", "task", NS,
      "Nursing Staff completes the nursing portion of the admission", "P4",
      ttype="manual"),

    # -- P5: Contact Sheet Review (Option A) ----------------------------
    N("Task_CheckAdditionalContacts", "task", CM,
      "Check with the Social Worker and Consumer for additional persons",
      "P5", ttype="user"),
    N("Gateway_AdditionalContactRequested", "gateway_x", CM,
    ...
    N("Task_CompleteROI", "task", CM,
      "Complete an ROI with the Consumer", "P5", ttype="user"),
    N("Task_RecordROIPurpose", "task", CM,
      ...
      doc=["Include applicable contact purposes such as visit, telephone "
           "call, or televisit."]),
    N("Task_ContactProspectiveContact", "task", CM,
      "Contact the Prospective Contact", "P5", ttype="send",
      doc=["Ask whether the person agrees to receive contact from the "
           "Consumer."]),
    N("Task_ProspectiveContactResponds", "task", PC,
      "Respond with agreement or decline", "P5", ttype="manual"),
    N("Gateway_ContactAgrees", "gateway_x", CM,
      "Prospective Contact agrees?", "P5"),
    N("Task_InformFloorStaffNewContact", "task", CM,
      "Inform Floor Staff that the contact may be added to the unit "
      "contact sheet", "P5", ttype="send"),
    N("Task_PlaceROIInChartOptionA", "task", CM,
      "Place the approved ROI in the consumer chart", "P5",
      ttype="manual"),
    N("Task_InformConsumerDeclined", "task", CM,
      "Inform the Consumer and do not authorize the contact", "P5",
      ttype="manual"),
    N("Gateway_ContactJoin", "gateway_x", CM,
      "", "P5"),
    N("Task_ConfirmContactSheet", "task", CM,
    ...
    N("Gateway_ClinicalEventJoin", "gateway_x", CM,
      "", "P6"),
    N("Gateway_PostAdmissionChange", "gateway_x", CM,
    ...
    N("Task_ProcessContactChange", "task", CM,
      "Process the requested change", "P6", ttype="user"),
    N("Task_VerifyROIForChange", "task", CM,
      "Complete and verify an ROI when required", "P6",
      ttype="user"),
    N("Task_CommunicateChangeToFloorStaff", "task", CM,
      "Communicate the approved change to Floor Staff", "P6",
      ttype="send"),
    N("Task_DeliverOngoingIssues", "task", CM,
    ...
    N("Gateway_HandoffTarget", "gateway_x", CM,
      "Handoff to Floor Staff or Social Worker?", "P6"),
    N("Task_FSReceivesHandoff", "task", FS,
      "Receive handoff of ongoing issues", "P6", ttype="manual"),
    N("Task_SWReceivesHandoff", "task", SW,
      "Receive handoff of ongoing issues", "P6", ttype="manual"),
    N("Gateway_HandoffJoin", "gateway_x", CM,
      "", "P6"),
    N("EndEvent_Complete", "end", CM,
