"""Declarative OFC-001 process data shared by generators and previews.

This module owns the process model and its presentation metadata. Consumers
should use MODEL rather than depending on generator module globals.
"""

from __future__ import annotations

from bpmn_engine import (
    Edge, ExternalPool, MessageFlow, Node, ProcessModel, ProcessOption,
    PreviewMetadata,
)
...
PREVIEW = PreviewMetadata(
    ...
    footer="Oklahoma Forensic Center · Security Unit · OFC-001 v1.1 · "
           "generated from the operating checklist by generate_bpmn.py",
)
